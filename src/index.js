...
function computeBuildSteadyDecision({
  ...
  if (!inBuild) {
    ...
    reasonText = "Kontrollierter Schwellenreiz erlaubt (Signal setzen, kein Ermüdungsaufbau).";
  }
